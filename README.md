# XYCrossTalkData
Numerical datasets underlying the figures of “Scalable Suppression of XY Crosstalk by Pulse-Level Control in Superconducting Quantum Processors” (arXiv:2601.05231)
...
- Remaining columns are y-axis datasets:
  - `*_infid_*`: gate/idle infidelity, defined as (1 - F).
